 ...
 * @date 时间: 2018年6月19日 下午3:31:51 <pre>
 * @Description 类描述: TODO 用于操作Reids
 */
...
public class RedisUtil {
    ...
    public static Keys getKeysMethod() {
        return new Keys();
    }

    public static Sets getSetMethod() {
        return new Sets();
    }

    public static SortSet getSortSetMethod() {
        return new SortSet();
    }

    public static Hash getHashMethod() {
        return new Hash();
    }

    public static Strings getStringsMethod() {
        return new Strings();
    }

    public static Lists getListsMethod() {
        return new Lists();
    }
    //---------------------序列化与反序列化----------------
    ...
    public static void set(String key, String value) {
        ...
        int vat = Math.abs(key.hashCode() % 16);
        jedis.select(vat);
        jedis.set(key, value);
        returnJedis(jedis);
    }
    ...
    public static class Keys {
        ...
        public long ttl(String key) {
            ...
            Jedis sjedis = JedisPoolUtils.getJedis();
            int vat = Math.abs(key.hashCode() % 16);
            sjedis.select(vat);
    ...
    public static class Sets {
        ...
        public long sdiffstore(String newkey, String... keys) {
            Jedis jedis = JedisPoolUtils.getJedis();
            int vat = Math.abs(newkey.hashCode() % 16);
            jedis.select(vat);
        ...
        public long smove(String srckey, String dstkey, String member) {
            Jedis jedis = JedisPoolUtils.getJedis();
            int vat = Math.abs(srckey.hashCode() % 16);
            jedis.select(vat);
    ...
    public static class Strings {
        ...
        public byte[] get(byte[] key) {
            //ShardedJedis sjedis = getShardedJedis();  
            Jedis sjedis = JedisPoolUtils.getJedis();
            int vat = Math.abs(Math.abs(key.hashCode() % 16));
            sjedis.select(vat);
        ...
        public String mset(String... keysvalues) {
            Jedis jedis = JedisPoolUtils.getJedis();
            int vat = keysvalues.hashCode() % 16;
            jedis.select(vat);
